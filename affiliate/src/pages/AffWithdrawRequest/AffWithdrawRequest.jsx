...
const StatCard = ({ icon, title, value, sub }) => (
  <div className="rounded-2xl border border-blue-200/12 bg-black/25 p-4">
    <div className="flex items-start justify-between gap-3">
      ...
      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-blue-300/10 bg-[#2f79c9]/20 text-[#8fc2f5]">
        {icon}
      </div>
    </div>
  </div>
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <div className={cardBase}>
          ...
          <div className="p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1fr_220px_170px]">
              ...
              <select
                ...
                className="w-full cursor-pointer rounded-2xl border border-blue-200/15 bg-black/45 px-4 py-3 text-white outline-none focus:border-[#63a8ee] focus:ring-2 focus:ring-[#63a8ee]/30"
              >
            ...
            <div className="mt-6 overflow-hidden rounded-3xl border border-blue-200/10">
                ...
                <table className="min-w-[1100px] w-full">
                  <thead className="bg-black/45">
                    <tr className="text-left">
                      ...
                      <th className="px-5 py-4 text-right text-sm font-bold text-[#a8d1fb]">
                        Actions
                      </th>
                    </tr>
                  </thead>
              ...
              <div className="space-y-4 bg-black/15 p-4 lg:hidden">
                {loading ? (
                  <div className="py-10 text-center text-blue-100/60">
                    Loading...
                  </div>
                ) : list.length ? (
                  list.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-3 text-xs text-blue-100/50">
                          {createdAt}
                        </div>
