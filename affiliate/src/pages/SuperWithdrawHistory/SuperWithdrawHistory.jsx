...
const SuperWithdrawHistory = () => {
  ...
  const fetchData = async (page = 1) => {
    ...
    try {
      ...
      const { data } = await api.get("/api/super-aff-withdraw-requests/my", {
        params,
      });
      ...
      toast.error(
        e?.response?.data?.message || "Failed to load super withdraw history",
      );
      setItems([]);
    } finally {
      setLoading(false);
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <div className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl">
                  Super Withdraw History
                </div>
                <div className="mt-1 text-sm text-blue-100/75">
                  Your previous super affiliate withdraw requests
                </div>
              </div>
            ...
            {isAuthed && !isSuperAffUser && (
              <div className="mb-5 rounded-2xl border border-red-400/25 bg-red-500/10 p-4">
                ...
                <div className="mt-1 text-sm text-red-100/85">
                  Only super affiliate users can view this withdraw history.
                </div>
              </div>
            )}
                  ...
                  <tbody className="bg-black/20">
                    {loading ? (
                          ...
                          >
                            ...
                            <td className="px-5 py-4">
                              <button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/super-dashboard/withdraw-history/${r._id}`,
                                  )
                                }
                                className={btnSecondary}
                              >
                      ...
                      <tr>
                        ...
                        >
                          No super withdraw history found.
                        </td>
                      </tr>
                    )}
                  </tbody>
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          navigate(`/super-dashboard/withdraw-history/${r._id}`)
                        }
