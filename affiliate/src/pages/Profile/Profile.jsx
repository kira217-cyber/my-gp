...
const Profile = () => {
  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      const { data } = await api.get("/api/affiliate/profile", { headers });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { data } = await api.put("/api/affiliate/profile", payload, {
        headers,
      });
          ...
          {loading ? (
            ...
            <div className="p-5 sm:p-6">
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                <div className="xl:col-span-2 rounded-3xl border border-blue-200/10 bg-black/25 p-5">
                  <h2 className="text-lg font-bold text-[#a8d1fb] mb-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        />
                        <FaUser className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8fc2f5]" />
                      </div>
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`${inputBase} pl-11`}
                        />
                        <FaEnvelope className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8fc2f5]" />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative" ref={dropdownRef}>
                        <button
                          ...
                          className="cursor-pointer flex h-12 w-full items-center justify-between rounded-2xl border border-blue-200/15 bg-black/45 px-4 text-white"
                        >
                          <div className="flex items-center gap-3">
                            <img
                              src={selectedCountry.flag}
                              alt={selectedCountry.name}
                              className="h-[18px] w-[28px] object-cover border border-blue-200/20"
                            />
                        ...
                        {dropdownOpen && (
                          <div className="absolute left-0 top-[56px] z-50 w-full rounded-2xl border border-blue-200/15 bg-[#07101d] shadow-2xl overflow-hidden">
                            ...
                            <div className="max-h-[260px] overflow-y-auto">
                              {filteredCountries.map((item) => (
                                <button
                                  ...
                                  className="cursor-pointer flex w-full items-center justify-between px-4 py-3 text-left hover:bg-white/5 transition"
                                >
                                  <div className="flex items-center gap-3">
                                    <img
                                      src={item.flag}
                                      alt={item.name}
                                      className="h-[16px] w-[26px] object-cover border border-blue-200/20"
                                    />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`${inputBase} pl-11`}
                        />
                        <FaPhoneAlt className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8fc2f5]" />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className={`${inputBase} pl-11 cursor-pointer appearance-none`}
                        >
                          <option value="BDT">BDT</option>
                          <option value="USDT">USDT</option>
                        </select>
                        <FaGlobe className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8fc2f5]" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        />
                        <FaLock className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8fc2f5]" />
                        <button
                          type="button"
                          onClick={() => setShowPassword((prev) => !prev)}
                          className="cursor-pointer absolute right-4 top-1/2 -translate-y-1/2 text-[#8fc2f5]"
                        >
                          {showPassword ? (
                    ...
                    <div className="rounded-2xl border border-blue-200/10 bg-black/20 p-4">
                      ...
                      <div className="mt-3 space-y-2 text-sm text-blue-100/75">
                        ...
                        <div>
                          Role:{" "}
                          <span className="font-bold text-white">
                            {originalProfile?.role || me?.role || "aff-user"}
                          </span>
                        </div>
                      </div>
                    </div>
