...
const textareaBase =
  "w-full min-h-[100px] rounded-2xl border border-blue-200/15 bg-black/40 px-4 py-3 text-white placeholder-blue-100/35 outline-none focus:ring-2 focus:ring-[#63a8ee]/30 focus:border-[#63a8ee] transition resize-y";
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-blue-200/15 bg-gradient-to-b from-black via-[#1d4175] to-black p-6 text-white shadow-2xl shadow-blue-900/40">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-red-500/15 border border-red-400/20 shrink-0">
            <FaTrash className="text-red-300 text-lg" />
          </div>
...
const AffAddWithdraw = () => {
  ...
  const onSave = async (values) => {
    ...
    try {
      ...
      await qc.invalidateQueries({ queryKey: ["admin-aff-withdraw-methods"] });
      await refetch();
        ...
        <div className={sectionCard}>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-blue-100/75">
                    Manage affiliate withdraw methods with bilingual fields and
                    custom form inputs
                  </p>
                </div>
              </div>
          ...
          <div className="p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              <div className="rounded-3xl border border-blue-200/10 bg-black/25 p-5 space-y-5">
              ...
              <div className="rounded-3xl border border-blue-200/10 bg-black/25 p-5 space-y-5">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-5">
                  <div className="h-32 w-32 overflow-hidden rounded-3xl border border-dashed border-blue-300/20 bg-black/40 flex items-center justify-center">
                    {logoPreview ? (
                      <img
                        src={logoPreview}
                        alt="Logo preview"
                  ...
                  >
                    <div className="mb-5 flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#2f79c9]/20 border border-blue-300/10 text-[#8fc2f5]">
                          <FaListAlt />
                        </div>
                        <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-blue-100/70">
                  View, edit, refresh, and manage all existing methods
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button onClick={clearForm} className={btnPrimary}>
                  <FaPlus />
                  New Method
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                {list.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className="h-20 w-20 overflow-hidden rounded-2xl border border-blue-200/10 bg-black/30 shrink-0 flex items-center justify-center">
                          {item.logoUrl ? (
                            <img
                            ...
                            <div className="text-center text-blue-100/30 text-[11px] font-bold">
                              NO LOGO
                            </div>
                          )}
                        </div>
