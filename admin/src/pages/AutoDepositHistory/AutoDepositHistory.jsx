...
const FieldRow = ({ k, v }) => (
  <div className="flex items-start justify-between gap-4 py-2.5 border-b border-blue-200/10">
    <div className="text-[12px] font-extrabold uppercase tracking-wide text-blue-100/60">
      {k}
    </div>
    <div className="text-[13px] font-bold text-white/90 text-right break-all">
      {v}
    </div>
  </div>
);
  ...
  return (
    <div className="p-4 lg:p-6">
      <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="px-5 py-5 md:px-6 md:py-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#63a8ee] to-[#2f79c9] px-5 py-3 font-extrabold text-white shadow-lg shadow-blue-700/30 transition hover:from-[#7bb7f1] hover:to-[#3b88db] disabled:opacity-60 cursor-pointer"
              >
        ...
        <div className="rounded-[28px] border border-blue-200/15 bg-black/30 backdrop-blur-xl text-white shadow-[0_20px_80px_rgba(47,121,201,0.18)] overflow-hidden">
          <div className="grid grid-cols-1 gap-4 border-b border-blue-200/10 p-5 md:grid-cols-[1fr_220px_220px] md:p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="w-full rounded-2xl border border-blue-200/15 bg-black/40 px-3 py-3 text-white outline-none cursor-pointer"
              >
                ...
                <table className="min-w-[1150px] w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-black/35 text-sm text-blue-100/85">
                      ...
                      <th className="px-6 py-4 font-extrabold text-right">
                        Action
                      </th>
                    </tr>
                  </thead>
                      ...
                      return (
                        <React.Fragment key={item._id}>
                          <tr className="border-b border-blue-200/8 hover:bg-white/[0.03]">
                            <td className="px-6 py-4 text-sm font-bold text-white/90 break-all">
                              {item.invoiceNumber || "—"}
                            </td>
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center justify-end gap-3">
                                ...
                                <button
                                  ...
                                  className="rounded-xl border border-blue-200/15 bg-white/5 p-2.5 text-blue-100 transition hover:bg-white/10 cursor-pointer"
                                >
                                  {isExpanded ? (
                                    <FaChevronUp />
                                  ) : (
                          ...
                          {isExpanded && (
                            <tr>
                              <td colSpan={8} className="p-0 bg-black/25">
                ...
                <div className="flex flex-col gap-4 border-t border-blue-200/10 px-6 py-5 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      disabled={page === 1}
                      className="rounded-xl border border-blue-200/15 bg-white/5 px-4 py-2 text-white transition hover:bg-white/10 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
                    >
                      Previous
                    </button>
