    ...
    <div className="min-h-[calc(100vh-120px)] text-white">
      ...
      {activateModalOpen && activatingUser && (
        <div className="fixed inset-0 z-[70] bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-2xl rounded-2xl border border-blue-300/20 bg-gradient-to-b from-black via-[#2f79c9]/15 to-black shadow-2xl shadow-blue-900/30 overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-blue-300/20 bg-gradient-to-r from-[#2f79c9]/30 to-[#63a8ee]/20">
              ...
              <button
                ...
                className="cursor-pointer p-2 rounded-lg hover:bg-blue-900/20 text-white"
              >
                <FaTimes />
              </button>
            </div>
            ...
            <div className="px-5 pb-5 md:px-6 md:pb-6 flex flex-col sm:flex-row justify-end gap-3">
              <button
                type="button"
                onClick={() => setActivateModalOpen(false)}
                className="cursor-pointer px-5 py-3 rounded-xl bg-black/50 border border-blue-300/20 text-white hover:bg-blue-900/20"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="cursor-pointer disabled:cursor-not-allowed disabled:opacity-60 px-5 py-3 rounded-xl bg-gradient-to-r from-[#63a8ee] to-[#2f79c9] text-white font-semibold hover:from-[#7ab6f2] hover:to-[#3c88db] shadow-lg shadow-blue-700/30"
              >
  ...
  return (
    <div>
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full px-4 py-3 rounded-xl bg-black/60 border border-blue-300/20 text-white placeholder-blue-100/40 focus:outline-none focus:ring-2 focus:ring-[#63a8ee]/30 focus:border-[#63a8ee]"
...
export default AllAffiliateUsers;
