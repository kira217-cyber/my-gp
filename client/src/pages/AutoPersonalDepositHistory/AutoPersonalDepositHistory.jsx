...
const AutoPersonalDepositHistory = () => {
  ...
  const userIdentity = reduxUser?._id || reduxUser?.id || "";
  ...
  const queryParams = useMemo(() => {
    ...
    params.append("userIdentity", String(userIdentity));
  ...
  }, [page, filters, userIdentity]);

  const { data, isLoading, isFetching, refetch } = useQuery({
    queryKey: ["auto-personal-deposit-history", queryParams],
    queryFn: async () => {
      if (!userIdentity) {
        return {
          success: true,
      ...
      const res = await api.get(
        `/api/auto-personal-deposit/history?${queryParams}`,
      );
      return res.data;
    },
  ...
  return (
    <div className="mt-2 w-full bg-[#f5f8fc] px-2 pb-5 text-[#1f2937] mt-2">
      <div className="space-y-4">
        <div className="rounded-[8px] border border-[#2f79c9]/15 bg-white p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] font-semibold text-slate-500">
                View your personal auto deposit records
              </p>
            </div>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 gap-3">
            ...
            <div>
              <label className="mb-2 flex items-center gap-2 text-[13px] font-bold text-[#1f5f98]">
                <FaMobileAlt className="text-[#f07a2a]" />
                Method
              </label>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="Invoice / TrxID / From / Method / Device"
                ...
                {isLoading ? (
                  ...
                  rows.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="max-w-[240px] px-4 py-4 text-[12px] font-black text-[#1f5f98]">
                      ...
                      <td className="px-4 py-4 text-[13px] font-bold text-slate-700">
                        ...
                        {money(item?.calc?.targetTurnover || item.amount || 0)}
                      </td>
                  ...
                  <tr>
                    <td colSpan={11} className="px-4 py-10 text-center">
                      <div className="text-[15px] font-black text-slate-500">
                        No auto personal deposit history found
                      </div>
                    </td>
                  </tr>
                )}
