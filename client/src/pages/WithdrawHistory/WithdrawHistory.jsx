              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="Method / Wallet / Note"
                ...
                {isLoading ? (
                  ...
                  rows.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-[13px] font-bold">
                        {item.walletSnapshot?.walletType || "N/A"}
                      </td>

                      <td className="max-w-[170px] px-4 py-4 text-[12px] font-bold text-slate-600">
                        <span className="line-clamp-2 break-all">
                          {item.walletSnapshot?.walletNumber || "N/A"}
                        </span>
                      </td>
